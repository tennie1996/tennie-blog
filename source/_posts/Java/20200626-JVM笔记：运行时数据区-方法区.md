...
![](https://foochane.cn/images/2020/072.png)
...
**堆、栈、方法区的交互关系**![](https://foochane.cn/images/2020/073.png)
...
```
![](https://foochane.cn/images/2020/074.png)
...
![](https://foochane.cn/images/2020/075.png)

- 在jdk8中，终于完全废弃了永久代的概念，改用与JRockit、J9一样在本地内存中实现的元空间（Metaspace）来代替

  ![](https://foochane.cn/images/2020/076.png)
...
## 4.方法区的内部结构
![](https://foochane.cn/images/2020/077.png) 《深入理解Java虚拟机》书中对方法区存储内容描述如下：它用于存储已被虚拟机加载的==类型信息、常量、静态变量、即时编译器编译后的代码缓存等。

![](https://foochane.cn/images/2020/078.png)
...
public static int count;
  ...
  public static final int number;
    ...
    ConstantValue: int 2
```
![](https://foochane.cn/images/2020/079.png)
...
#### 常量池
![](https://foochane.cn/images/2020/080.png)

>  具体可以查看官方文档：[https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.3.3](https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.3.3)
...
25 return
```
![](https://foochane.cn/images/2020/081.png)
...
![](https://foochane.cn/images/2020/082.png)![](https://cdn.nlark.com/yuque/0/2020/webp/910643/1593609554621-5b1f6111-b826-4ee0-bd65-dc58211d9194.webp#align=left&display=inline&height=568&margin=%5Bobject%20Object%5D&originHeight=568&originWidth=1280&size=0&status=done&style=none&width=80%25)
...
- 接着，找到了一个引用该staticObj对象的地方，是在一个java. lang . Class的实例里，并且给出了这个实例的地址，通过Inspector查看该对象实例，可以清楚看到这确实是一个 java.lang.Class类型的对象实例，里面有一个名为staticObj的实例字段：![](https://foochane.cn/images/2020/083.png)
...
## 7.方法区的垃圾回收
有些人认为方法区（如Hotspot，虚拟机中的元空间或者永久代）是没有垃圾收集行为的，其实不然。《Java 虚拟机规范》对方法区的约束是非常宽松的，提到过可以不要求虚拟机在方法区中实现垃圾收集。事实上也确实有未实现或未能完整实现方法区类型卸载的收集器存在（如 JDK11 时期的 2GC 收集器就不支持类卸载）。<br />
...
## 8. 总结
![](https://foochane.cn/images/2020/084.png)
