...
![](https://foochane.cn/images/2020/038.png)
...
- 对于栈来说不存在垃圾回收问题
     ...
     ![](https://foochane.cn/images/2020/039.png)
...
![](https://foochane.cn/images/2020/040.png)
```java
/**
 * 栈帧
 */
...
![](https://foochane.cn/images/2020/041.png)
...
利用javap -v 命令对字节码文件进行解析查看局部变量表，如图：

![](https://foochane.cn/images/2020/042.png)

也可以在IDEA 上安装jclasslib byte viewcoder插件查看字节码信息,以main()方法为例

![](https://foochane.cn/images/2020/043.png)
...
![](https://foochane.cn/images/2020/044.png)
...
##### 代码追踪
![](https://foochane.cn/images/2020/045.png)
...
![](https://foochane.cn/images/2020/046.png)
...
![](https://foochane.cn/images/2020/047.png)
...
![](https://foochane.cn/images/2020/048.png)

**⑦iadd操作结果23入栈；⑧将23存储在局部变量表索引为3的位置上**



![](https://foochane.cn/images/2020/049.png)

#### 4.2  i++ 和 ++i的区别

![](https://foochane.cn/images/2020/050.png)
...
![](https://foochane.cn/images/2020/051.png)
...
常量池的作用，就是为了提供一些符号和常量，便于指令的识别。<br />





![](https://foochane.cn/images/2020/052.png)
...
![](https://foochane.cn/images/2020/053.png)
...
2、在方法执行的过程中遇到了异常（Exception），并且这个异常没有在方法内进行处理，也就是只要在本方法的异常表中没有搜素到匹配的异常处理器，就会导致方法退出，简称**异常完成出口**<br />方法执行过程中抛出异常时的异常处理，存储在一个异常处理表，方便在发生异常的时候找到处理异常的代码。
...
1. 举例栈溢出的情况？（StackOverflowError）
   ...
   答：递归调用等，通过-Xss设置栈的大小；



2. 调整栈的大小，就能保证不出现溢出么？

   答：**不能  ** 如递归无限次数肯定会溢出，调整栈大小只能保证溢出的时间晚一些
